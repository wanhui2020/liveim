        ...
        layui.use(['table', 'laydate'], function () {
            ...
            let tableIns = table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'award', title: '奖励', align: 'center', width: 120}
                    , {field: 'lx_days', title: '连续签到天数', align: 'center', width: 120}
                    , {field: 'bq_date', title: '补签日期', align: 'center'}
            ...
            table.on('tool(lists)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail') { //查看
                    ...
                    var p = layer.confirm('确定要删除该条数据？', function (index) {
                        layer.close(p);
                        layer.load();
                        axios.post("{{url('system/member/signin/destroy')}}", {ids: [data.id]})
