                    ...
                    <div class="layui-card-body" pad15>
                        ...
                        <div class="layui-form" lay-filter="formData">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" id="text_url" name="url" lay-verify="required" placeholder="请输入资源路径"
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    @else
                                        <input type="radio" name="is_cover" value="0" title="否" >
                                        <input type="radio" name="is_cover" value="1" title="是" checked>
                                    @endif
                                </div>
                            </div>
                            <div class="layui-form-item">
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    layer.load();
                    axios.post("{{url('system/member/file/update')}}", field)
