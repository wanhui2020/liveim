        ...
        layui.use(['table'], function () {
            ...
            let tableIns = table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'type_cn', title: '消息类型', align: 'center', width: 120}
                    , {field: 'content', title: '消息内容'}
                    , {
                        field: 'to_id', title: '接收人', align: 'center', width: 180, templet: function (d) {
                            if (d.tomember == null) {
                                return '所有会员';
                            }else if(d.tomember.code){
                    ...
                    , {
                        field: 'member_id', title: '相关会员', align: 'center', width: 180, templet: function (d) {
                            if (d.member == null) {
                                return '-';
                            }else if(d.tomember.code){
