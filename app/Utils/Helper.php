...
class Helper
{
     ...
     * @return string
     */
    public static function rand_str($randLength = 6, $addtime = 1, $includenumber = 0)
    {
        if ($includenumber) {
    ...
    public static function XmlToArray($value)
    {
        try {
            if (is_string($value)) {
                ...
                $value_array = json_decode(json_encode(simplexml_load_string($value, 'SimpleXMLElement', LIBXML_NOCDATA)), true);
                return $value_array;
            }
            return false;
        } catch (Exception $ex) {
     ...
     * 将null转换成''
     * */
    public static function nulltostr($val)
    {
